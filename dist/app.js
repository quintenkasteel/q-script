...
console.log("pair arr", _.fromPair([['a', 1], ['b', 2]]));
...
console.log("keyBy { data: { id: 'a1', title: 'abc' }}, 'id'", _.keyBy([{ data: { id: 'a1', title: 'abc' }}], 'id'));
console.log("keyBy { data: { id: 'a1', title: 'abc' }}, 'id'", _.keyBy([{ id: 'a1', title: 'abc' }, { id: 'b2', title: 'def' }], 'id'));
console.log("minBy [{ value: 6 }, { value: 2 }, { value: 4 }], 'value'",_.minBy([{ value: 6 }, { value: 2 }, { value: 4 }], 'value'));
console.log("maxBy [{ value: 6 }, { value: 2 }, { value: 4 }], 'value'", _.maxBy([{ value: 6 }, { value: 2 }, { value: 4 }], 'value'));
console.log("[{name: 'Alice'}, {name: 'Bob', id: 3}, {name: 'Jeremy'}], 'name'", _.pluck([{name: "Alice"}, {name: "Bob", id: 3}, {name: "Jeremy"}], 'name'));
console.log("sample [1, 2, 3, 4, 5]", _.sample([1, 2, 3, 4, 5]));
console.log("size [1, 2, 3, 4, 5]", _.size([{i: 1}, {e: 2}, {f: 3}, {h: 4}, {g: 5}]));
const fruits = [
...
console.log("keys {one: 1, two: 2, three: 3}", _.keys({one: 1, two: 2, three: 3}))
console.log("pick { 'a': 1, 'b': '2', 'c': 3 }, ['a', 'c']", _.pick({ 'a': 1, 'b': '2', 'c': 3 }, ['a', 'c']));
console.log("pickBy { 'a': 1, 'b': null, 'c': 3, 'd': false, 'e': undefined }", _.pickBy({ 'a': 1, 'b': null, 'c': 3, 'd': false, 'e': undefined }));
console.log("values {one: 1, two: 2, three: 3}", _.values({one: 1, two: 2, three: 3}));
